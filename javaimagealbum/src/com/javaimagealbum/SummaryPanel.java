    ...
    implements WizardPanel, Observer
{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        tpInstructions.setText("WebPhotoPublish is now ready to generate your photo album.  Just click the Generate button below to start generating the output.  The following settings will be used:");
