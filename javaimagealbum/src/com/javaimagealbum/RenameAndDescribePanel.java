...
implements WizardPanel, TableModelListener, ListSelectionListener
{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("Rename and Add Captions");
        ...
        tpInstructions.setText("You can change the filename and provide a caption for each image to be published.  Use the up and down arrows to change the order of the images and the \"Auto Preview\" checkbox to preview the image.  Use the modifiers below to adjust each image.\n\nWhen you are done, click Next.\n\n\n\n");
        pnlLeft.add(tpInstructions);

        pnlModifiers.setBackground(java.awt.Color.white);
        pnlModifiers.setBorder(new javax.swing.border.TitledBorder("Modifiers"));
        ...
        pnlPreview.setBorder(new javax.swing.border.TitledBorder("Preview"));
        ...
        cbAutoPreview.setText("Auto Preview");
