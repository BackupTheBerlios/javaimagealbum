    ...
    implements WizardPanel, ItemListener
{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("Choose Output Directory");
        ...
        tpInstructions.setText("Choose the folder to store the published pictures in:");
    ...
    private void selectDirectory( File dir ) {
        ...
        if( !dir.exists() ) {
            ...
            int result = JOptionPane.showConfirmDialog( this, 
                "Folder does not exist.  Do you wish to create it?",
    ...
    private void couldNotCreateFolder() {
        ...
        JOptionPane.showMessageDialog( this, 
            "The new folder could not be created in the\n" +
    ...
    private void updateGUI() {
        ...
        // Update UI:
        tpChoiceDescription.setText( "Selection: " + selection );
        ...
        throws CannotChangePanelException 
    {
        if( forwardDirection ) {
                ...
                publishManager.getPhotoSource().getSourceDir() ) ) 
            {
                Toolkit.getDefaultToolkit().beep();
                int result = JOptionPane.showConfirmDialog( this, 
                    "Choosing the same output folder as the one your\n" +
                ...
                if( atLeastOneFile ) {
                    Toolkit.getDefaultToolkit().beep();
                    int result = JOptionPane.showConfirmDialog( this,
                        "The folder you selected already contains one or\n" +
