...
public class OutputOptionsPanel extends javax.swing.JPanel implements WizardPanel
{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        pnlShowExif = new javax.swing.JPanel();
        ...
        lblAlbumDescription.setText("Album Descrption:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 5, 5);
        pnlAlbumTitleOption.add(lblAlbumDescription, gridBagConstraints);

        tfAlbumDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        tfAlbumDescription.setText("Album Descrption");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        pnlShowExif.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        pnlShowExif.setBackground(java.awt.Color.white);
        cbShowExif.setBackground(java.awt.Color.white);
        cbShowExif.setFont(new java.awt.Font("SansSerif", 0, 12));
        cbShowExif.setMnemonic('e');
        cbShowExif.setText("Show EXIF information.");
        cbShowExif.setToolTipText("Select this option if you whant to have EXIF information printed.");
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 0);
        pnlCheckboxes.add(pnlShowExif, gridBagConstraints);
        ...
        cbCaptionPosition.setBackground(java.awt.Color.white);
        ...
        cbCaptionAlign.setBackground(java.awt.Color.white);
        ...
        cbPhotoPosition.setBackground(java.awt.Color.white);
        ...
        // Padding for pnlDetailPages usd to have options on top
    ...
    private void cbCaptionPositionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbCaptionPositionActionPerformed
        scanAndPersistOptions();
  ...
  private void cbResizeAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbResizeAllActionPerformed
    ...
    private javax.swing.JPanel pnlShowExif;
