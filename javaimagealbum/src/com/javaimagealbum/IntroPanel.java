...
//        lblCompany = new javax.swing.JLabel();
        ...
        tpDescription.setText("This program will guide you through the process of publishing your photographs to the web.  The result will be a directory with .html and .jpg / .png files that you can upload to your current web host.\n\nPress the next button below and follow the steps on each screen.");
...
//        lblCompany.setFont(new java.awt.Font("SansSerif", 1, 14));
//        lblCompany.setForeground(new java.awt.Color(0, 153, 153));
//        lblCompany.setText("Octagon Software");
//        lblCompany.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(3, 3, 3, 3)));
//        pnlTitle.add(lblCompany);
