...
//                    JOptionPane.INFORMATION_MESSAGE );
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        btnRestart.setMnemonic(resM.getString("Restart").charAt(0));
        btnRestart.setText(res.getString("RESTART"));
        ...
        btnBack.setMnemonic(resM.getString("Back").charAt(0));
        btnBack.setText("<< "+res.getString("BACK"));
        ...
        btnNext.setMnemonic(resM.getString("Next").charAt(0));
        btnNext.setText(res.getString("NEXT")+" >>");
        ...
        btnCancel.setMnemonic(resM.getString("Cancel").charAt(0));
  ...
  private void btnRestartActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
      restartPanel();
